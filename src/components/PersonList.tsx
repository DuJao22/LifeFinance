  ...
  return (
    <div className="space-y-6 pb-24 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-extrabold text-slate-100">{title}</h2>
      ...
      <div className="bg-slate-900/80 p-4 rounded-2xl border border-slate-800 shadow-xl backdrop-blur-md space-y-3">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-800/80 border border-slate-700/80 text-slate-100 text-xs focus:outline-none focus:border-blue-500 transition-all placeholder-slate-500"
            />
          </div>
            ...
            {sortedRecords.map((record) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative flex flex-col justify-between p-5 rounded-3xl bg-slate-900/90 border backdrop-blur-md shadow-xl transition-all ${
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white font-bold flex items-center justify-center text-base shadow-inner overflow-hidden border border-slate-700 shrink-0">
                          {record.photo ? (
                        ...
                        <div>
                          <h3 className="font-bold text-sm text-slate-100 line-clamp-1">{record.name}</h3>
                          <p className="text-xs text-slate-400 line-clamp-1">{record.description}</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-slate-800/50 p-3 rounded-2xl border border-slate-700/40 my-3 space-y-1.5 text-xs">
                      ...
                      <div className="flex justify-between border-t border-slate-700/60 pt-1.5 font-bold">
                        ...
                        <span className={remaining > 0 ? (type === 'DEVO' ? 'text-rose-400' : 'text-emerald-400') : 'text-slate-400'}>
